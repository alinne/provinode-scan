...
- QR payload import enforces pairing endpoint `https`, non-expired TTL, wire major version compatibility, SHA-256 fingerprint shape, non-empty Base64 signature payload, and valid QUIC endpoint host:port before applying settings.
