...
- QR payload import enforces pairing endpoint `https`, non-expired TTL, wire major version compatibility, SHA-256 fingerprint shape, and non-empty Base64 signature payload before applying settings.
