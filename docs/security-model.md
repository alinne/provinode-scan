...
- QR payload import enforces pairing endpoint `https`, non-expired TTL, wire major version compatibility, and SHA-256 fingerprint shape validation before applying settings.
