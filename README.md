...
- Import validates endpoint security and freshness (`https`, non-expired token, supported wire major, valid desktop fingerprint, Base64 signature payload, valid QUIC endpoint host:port).
